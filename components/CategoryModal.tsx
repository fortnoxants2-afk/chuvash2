    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-[360px] aspect-[556/740] flex flex-col items-center">
        ...
        <div className="relative z-10 w-full h-full flex flex-col pt-[20%] pb-[5%] px-[12%]">
          {/* Список категорий */}
          <div className="flex-1 flex flex-col justify-center gap-y-[3.5%] overflow-y-auto scrollbar-hide">
            {CATEGORY_ORDER.map((id) => {
              ...
              return (
                <button
                  ...
                  className="flex items-center gap-x-4 w-full group py-1 text-left outline-none"
                >
                  ...
                  <span className="text-[#5d3a24] font-bold text-[17px] leading-tight">
                    {CATEGORY_NAMES[id]}
                  </span>
                </button>
              );
